...
function concatenare(str1=ciao, str2=tutti) {
  let a = str1.slice(0, 2);       // Prendi i primi 2 caratteri della prima stringa
  let b = str2.slice(-3);     // Prendi gli ultimi 3 caratteri della seconda stringa
  let str3 = ( a + b ).toUpperCase();   // Concatenazione della stringa due parti e conversione in maiuscolo
  return str3;
  
  //console.log(str3)     // Risultato in console.
}
...
function valPari () {
  let arr1 = [52, 37, 88, 15, 65, 49, 79, 3, 92, 61]
}
